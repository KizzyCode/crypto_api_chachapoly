...
#[macro_export] macro_rules! write32_le {
	($num:expr => $data:expr) => ({
...
#[macro_export] macro_rules! write64_le {
	($num:expr => $data:expr) => ({
